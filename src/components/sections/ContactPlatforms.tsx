...
const ContactPlatforms = () => {
  const platforms = [
    {
      name: "GitHub",
      url: "https://github.com/jadhavharshh",
      icon: (
    ...
    {
      name: "LinkedIn",
      url: "https://linkedin.com/in/jadhavharsh",
    ...
    {
      name: "Twitter",
      url: "https://x.com/theharshjadhav",
      icon: (
        <svg className="w-3 h-3" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: "Discord",
      url: "https://discord.com/users/theharshjadhav",
      icon: (
        <svg className="w-3 h-3" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: "Telegram",
      url: "https://t.me/theharshjadhav",
      icon: (
        <svg className="w-3 h-3" fill="currentColor" viewBox="0 0 24 24">
          <path d="M11.944 0A12 12 0 0 0 0 12a12 12 0 0 0 12 12 12 12 0 0 0 12-12A12 12 0 0 0 12 0a12 12 0 0 0-.056 0zM16.906 7.05c.144.045.27.118.377.213.122.104.18.22.177.344a.801.801 0 0 1-.059.307l-2.932 9.908a.72.72 0 0 1-.466.468.802.802 0 0 1-.573.004.722.722 0 0 1-.256-.177l-2.895-2.893-1.567 1.567a.65.65 0 0 1-.45.183.728.728 0 0 1-.53-.183.616.616 0 0 1-.183-.45l-.013-.202v-.316l.014-.307.055-1.213.803-7.03a.756.756 0 0 1 .42-.592.869.869 0 0 1 .357-.082z"/>
        </svg>
      )
    },
    {
      name: "Email",
      url: "mailto:realharshjadhav@gmail.com",
      icon: (
    ...
    {
      name: "LeetCode",
      url: "https://leetcode.com/u/jadhavharsh/", // Update with your actual LeetCode profile URL
      icon: (
  ...
  return (
    <div className="my-12">
      <div className="mb-6">
        <h2 className="text-lg font-semibold text-foreground">Connect With Me</h2>
        <p className="text-sm text-muted-foreground">Find me across the web</p>
      </div>
