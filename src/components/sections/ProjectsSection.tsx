                ...
                {projects.map((project, index) => (
                            ...
                            <div className="relative aspect-video overflow-hidden">
                                ...
                                <div className="relative h-full w-full overflow-hidden transition-transform duration-500 group-hover:scale-105"
                                    ...
                                    <div className="absolute inset-0 flex items-center justify-center text-muted-foreground">
                                        {/* Empty image placeholder with no text */}
                                    </div>
                  ...
                  /> */}
                            ...
                            <div className="p-6 flex flex-col flex-grow"
                                ...
                                {/* Fixed tech tags to properly wrap */}
                                <div className="flex flex-wrap gap-1.5 mt-auto mb-4 w-full"
                                    style={{ transform: 'translateZ(20px)' }}>
                                    {project.technologies.map((tech) => (
                                        <span
                                            key={tech}
                                            className="px-1.5 py-0.5 bg-accent/50 text-accent-foreground rounded-full text-xs inline-block mb-1"
                                        >
                                            {tech}
                                        </span>
                                    ))}
